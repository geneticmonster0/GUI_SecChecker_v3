...
BULK INSERT [dbo].[SCCM]
    FROM 'C:\Users\geneticmonster0\Desktop\temp\proverki\proverki\By_Date\2016-11-15\SZB\SCCM\?????????? ??? ??????? SCCM.csv'
    WITH
    (
    FIRSTROW = 2,
...
BULK INSERT [dbo].[MP]
    FROM 'C:\Users\geneticmonster0\Desktop\temp\proverki\proverki\By_Date\2016-11-15\SZB\MP\p1.csv'
    WITH
    (
    FIRSTROW = 2,
